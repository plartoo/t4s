...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_student', (
            ...
            ('role', self.gf('django.db.models.fields.CharField')(default='student member', max_length=30)),
        ))
        db.send_create_signal(u'accounts', ['Student'])

        # Adding M2M table for field groups on 'Student'
        m2m_table_name = db.shorten_name(u'accounts_student_groups')
        ...
        db.create_table(u'accounts_advisor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizations.School'])),
        ))
        db.send_create_signal(u'accounts', ['Advisor'])

        # Adding M2M table for field groups on 'Advisor'
        m2m_table_name = db.shorten_name(u'accounts_advisor_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('advisor', models.ForeignKey(orm[u'accounts.advisor'], null=False)),
            ('group', models.ForeignKey(orm[u'organizations.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['advisor_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'accounts_student_groups'))

        # Deleting model 'Advisor'
        db.delete_table(u'accounts_advisor')

        # Removing M2M table for field groups on 'Advisor'
        db.delete_table(db.shorten_name(u'accounts_advisor_groups'))
