...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.keywords'
        db.add_column(u'campaigns_campaign', 'keywords',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.keywords'
        db.delete_column(u'campaigns_campaign', 'keywords')
