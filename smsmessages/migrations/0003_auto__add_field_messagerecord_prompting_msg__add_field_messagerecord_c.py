...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageRecord.prompting_msg'
        db.add_column(u'smsmessages_messagerecord', 'prompting_msg',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='prompting_msg', null=True, to=orm['smsmessages.Message']),
                      keep_default=False)

        # Adding field 'MessageRecord.campaign'
        db.add_column(u'smsmessages_messagerecord', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaigns.Campaign'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MessageRecord.task_queue'
        db.add_column(u'smsmessages_messagerecord', 'task_queue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaigns.TaskQueue'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MessageRecord.sender'
        db.add_column(u'smsmessages_messagerecord', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sender', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'MessageRecord.receiver'
        db.add_column(u'smsmessages_messagerecord', 'receiver',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='receiver', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageRecord.prompting_msg'
        db.delete_column(u'smsmessages_messagerecord', 'prompting_msg_id')

        # Deleting field 'MessageRecord.campaign'
        db.delete_column(u'smsmessages_messagerecord', 'campaign_id')

        # Deleting field 'MessageRecord.task_queue'
        db.delete_column(u'smsmessages_messagerecord', 'task_queue_id')

        # Deleting field 'MessageRecord.sender'
        db.delete_column(u'smsmessages_messagerecord', 'sender_id')

        # Deleting field 'MessageRecord.receiver'
        db.delete_column(u'smsmessages_messagerecord', 'receiver_id')
