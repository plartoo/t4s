...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MessageRecord.receiver_num'
        db.alter_column(u'smsmessages_messagerecord', 'receiver_num', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'MessageRecord.sender_num'
        db.alter_column(u'smsmessages_messagerecord', 'sender_num', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'MessageRecord.receiver_num'
        db.alter_column(u'smsmessages_messagerecord', 'receiver_num', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'MessageRecord.sender_num'
        db.alter_column(u'smsmessages_messagerecord', 'sender_num', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'smsmessages.messagerecord': {
            ...
            'receiver_num': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sender'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'sender_num': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
